package hoods.com.jetexpense.presentation.income.components
...
private fun <E> List<E>.extractProportions(selector: (E) -> Float): List<Float> {
...
@Composable
fun PrevTransactionStatement() {
    JetExpenseTheme {
        TransactionStatement(
            items = dummyIncomeList,
            colors = {
                getColor(it.incomeAmount.toFloat(), Util.incomeColor)
            },
            amounts = { it.incomeAmount.toFloat() },
            amountsTotal = dummyIncomeList.sumOf { it.incomeAmount }.toFloat(),
            circleLabel = "Receive",
            onItemSwiped = {},
            key = { it.id },
        ) {
